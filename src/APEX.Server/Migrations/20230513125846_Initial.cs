        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFolder = table.Column<byte>(type: "tinyint", nullable: false),
                    ...
                    ParentContainerId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Files_AspNetUsers_ModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserContainerMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserContainerMappings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserContainerMappings_FileContainers_ContainerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileContainers_RootFolderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserContainerMappings_ContainerId",
                table: "UserContainerMappings",
                column: "ContainerId");

            migrationBuilder.CreateIndex(
                name: "IX_UserContainerMappings_UserId",
                table: "UserContainerMappings",
                column: "UserId");

            migrationBuilder.AddForeignKey(
                name: "FK_FileContainers_Files_RootFolderId",
                table: "FileContainers",
                column: "RootFolderId",
                principalTable: "Files",
                principalColumn: "Id",
